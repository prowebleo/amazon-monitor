...
Wanted a quick way to spot price drops on specific GPUs without refreshing Amazon pages. The scraper runs at 6 AM UTC, stores snapshots in libSQL, and the dashboard updates automatically.
